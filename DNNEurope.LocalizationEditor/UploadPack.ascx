...
<asp:Wizard ID="wzdImport" runat="server" DisplayCancelButton="True" 
 ...
 <HeaderTemplate>
  <asp:Label ID="lblTitle" CssClass="Head" runat="server"><%=DotNetNuke.Services.Localization.Localization.GetString(wzdImport.ActiveStep.Title + ".Title", Me.LocalResourceFile)%></asp:Label><br /><br />
 ...
 <WizardSteps>
  <asp:WizardStep ID="WizardStep1" runat="server" title="StepUpload" StepType="Start" AllowReturn="False">
   <asp:FileUpload runat="server" ID="ctlUpload" />
   <p><asp:Label runat="server" ID="lblUploadError" CssClass="NormalRed" /></p>
   <p><asp:Label runat="server" ID="lblUploadReport" CssClass="Normal" /></p>
  </asp:WizardStep>
    ...
    <table cellspacing="0" cellpadding="2" border="0">
     <tr>
      <td class="SubHead" width="165">
       <dnn:label id="plObject" runat="server" suffix=":" />
      </td>
      <td>
       <%=ModuleFriendlyName%>
      </td>
     ...
     <tr>
      ...
      <td>
       <asp:TextBox runat="server" ID="txtResult" Width="400" Height="200" TextMode="MultiLine" Wrap="False" />
      </td>
     </tr>
     <tr>
      <td class="SubHead" width="165">
  ...
  <asp:WizardStep ID="WizardStep3" runat="server" title="StepConfirm" StepType="Finish">
   <p><dnn:label id="plAnalysis" runat="server" controlname="txtAnalysis" suffix=":" /></p>
   <p><asp:TextBox runat="server" ID="txtAnalysis" Width="550" Height="400" TextMode="MultiLine" Wrap="False" /></p>
  </asp:WizardStep>
 </WizardSteps>
</asp:Wizard>
