<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DownloadPack.ascx.vb" Inherits="DNNEurope.Modules.LocalizationEditor.DownloadPack" %>
...
<p>
 <asp:DataGrid 
  ...
  CellPadding="2" CellSpacing="4" AutoGenerateColumns="False"
  HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal">
  <Columns>
...
<p><asp:Hyperlink runat="server" ID="cmdReturn" resourcekey="cmdReturn" Text="Return" CssClass="CommandButton" /></p>
