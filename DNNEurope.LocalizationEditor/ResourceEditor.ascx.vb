...
#Region " Overrides "
  Public Overrides Sub DataBind()
   ...
   End If
   If toLanguage = Google.API.Language.Unknown And Locale.Length = 2 Then
    toLanguage = Google.API.Translate.LanguageUtility.GetLanguageFromLocale(Locale & "-" & Locale.ToUpper)
   End If
