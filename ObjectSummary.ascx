...
<ul class="dnnActions dnnClear">
    <li>
        <asp:LinkButton runat="server" ID="cmdEdit" resourcekey="cmdEdit" Text="Edit" CssClass="dnnPrimaryAction" /></li>
    <li>
        <asp:HyperLink runat="server" ID="cmdDownload" resourcekey="cmdDownload" Text="Download" CssClass="dnnSecondaryAction" /></li>
    <li>
        <asp:HyperLink runat="server" ID="cmdReturn" resourcekey="cmdReturn" Text="Return" CssClass="dnnSecondaryAction" /></li>
</ul>
